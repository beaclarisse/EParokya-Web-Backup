...
router.put(
  "/confirmPrayer/:prayerId",
  isAuthenticatedUser,
  PrayerWallController.confirmPrayerRequest
);

router.get(
  "/confirmedPryers",
  isAuthenticatedUser,
  PrayerWallController.getConfirmedPrayers
);

router.put(
  "/toggle-like/:prayerId",
  isAuthenticatedUser,
  PrayerWallController.toggleLike
);
